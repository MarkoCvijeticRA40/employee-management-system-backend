...
public class CreateProjectUserAssignmentValidator implements Validator<ProjectUserAssignment> {
    ...
    public ValidationReport validate(ProjectUserAssignment projectUserAssignment) {
        ...
        if (projectUserAssignment == null) {
            ...
            if (projectUserAssignment.getEndOfWork() == null) {
                report.setValid(false);
                report.addMessage(ProjectUserAssignmentConstant.END_OF_WORK, "end of work is null");
            }
        }
        return report;
    }
