...
public class UpdateUserCodesValidator implements Validator<User> {
    ...
    public ValidationReport validate(User user) {
        ...
        if (user == null) {
            ...
            /*if (user.getValidationCode() == -1) {
                report.setValid(false);
                report.addMessage(UserConstant.VALIDATION_CODE,"Validation code is missing.");
            }*/
        }
        return report;
    }
